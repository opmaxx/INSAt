...
uint8_t GDO0_FLAG = 0; //Flag of the tx threshold interrupt. Used to control the reading and writing to the buffer and to check the
						//arrival of a packet.
...
//----------------------[PATABLES]---------------------------------------------
/*PATABLES Registers presets for various frequencies. This values are the (supposed) optimal values for -30, -20, -15,
